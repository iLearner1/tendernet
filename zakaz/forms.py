...
class Iso(forms.Form):
    ...
    CHOICES2 = (('Комментарий', 'Комментарий'), ('Комментарий', 'Комментарий'))

    CHOICES3 = (('1-10 человек', '1-10 человек'), ('11-50 человек', '11-50 человек'),
                ('51-100 человек', '51-100 человек'), ('Более 100 человек', 'Более 100 человек'))

    CHOICES4 = (('Комментарий', 'Комментарий'), ('Комментарий', 'Комментарий'))
