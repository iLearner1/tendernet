...
class Iso(forms.Form):
    CHOICES = (('Да', 'Да'), ('Комментарии', 'Комментарии'),
               ('1-10 человек', '1-10 человек'), ('11-50 человек', '11-50 человек'))
    CHOICES2 = (('Да', 'Да'), ('Комментарии', 'Комментарии'),
                ('1-10 человек2', '1-10 человек2'), ('11-50 человек2', '11-50 человек2'))
    CHOICES3 = (('Да', 'Да'), ('Комментарии', 'Комментарии'),
                ('1-10 человек3', '1-10 человек3'), ('11-50 человек3', '11-50 человек3'))
    CHOICES4 = (('Да', 'Да'), ('Комментарии', 'Комментарии'),
                ('1-10 человек4', '1-10 человек4'), ('11-50 человек4', '11-50 человек4'))
